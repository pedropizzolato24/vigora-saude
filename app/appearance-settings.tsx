              ...
              {FONT_SIZES.map((size) => {
                ...
                return (
                  <Pressable
                    ...
                    accessibilityState={{ selected }}
                    accessibilityLabel={FONT_SIZE_LABELS[size]}
                    style={({ pressed }) => [{ flex: 1, minHeight: fs.touch(48), alignItems: 'center', justifyContent: 'center', borderRadius: 10, borderWidth: 1.5, backgroundColor: selected ? colors.primarySurface : colors.background, borderColor: selected ? colors.primary : colors.border, opacity: pressed ? 0.7 : 1 }]}
                  >
